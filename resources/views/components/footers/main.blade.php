        ...
        <div class="mt-12 grid md:grid-cols-3 gap-8 xl:col-span-2 xl:mt-0">
            <div><h3 class="text-lg font-medium text-everglade-500">Nomad Listings</h3>
                <ul role="list" class="mt-2 space-y-1">
                    ...
                    <li><a href="/listings/locations" class="text-sm text-gray-500 hover:text-everglade-500">Listings per Country</a></li>
                    <li><a href="/listings/locations" class="text-sm text-gray-500 hover:text-everglade-500">Listings per City</a></li>
