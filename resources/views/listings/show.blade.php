...
<div class="max-w-screen-xl mx-auto space-y-5" x-data="{ amenitiesDialogOpen: false }">
    ...
    <div class="space-y-2">
        <div class="space-y-2 w-full justify-between sm:p-0 px-2 grid grid-cols-2">
            <h1
                class="font-display tracking-tighter text-lg sm:text-xl col-span-1">Modern Paradise with Pool across 8
                Secluded Acres</h1>
            <div class="col-span-1 flex justify-end">
                <div class="font-display tracking-tighter flex items-center gap-2 text-sm justify-end">Nomad Validated
        ...
        <div class="flex justify-between w-full">
            ...
            <div class="font-display tracking-tighter text-3xl font-medium sm:p-0 px-2">
                ...
                <span class="text-sm sm:text-lg italic text-everglade-600 font-serif tracking-tighter">/ night</span>
            </div>
        </div>
    </div>
    ...
    {{-- Main Image   --}}
    <div class="relative w-full h-96 sm:p-0 px-2">
    ...
    <div class="flex items-center justify-center">
        <button x-on:click="amenitiesDialogOpen = true" class="focus:outline-none focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black active:text-white/70 inline-flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-white bg-everglade-600 hover:bg-everglade-500">
            See all amenities
        </button>
    </div>
    <div>
