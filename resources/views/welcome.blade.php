    ...
    <div class="max-w-screen-xl mx-auto my-10 px-4 ">
        ...
        <div>
            <ul class="max-w-screen-xl mx-auto grid grid-cols-1 gap-x-5 gap-y-2 sm:gap-x-5 md:grid-cols-2 lg:grid-cols-3">
                <li class="cursor-pointer bg-white col-span-1 flex flex-col max-w-xl">
                    <a href="/listings/1543" class="block">
                        <div class="flex-shrink-0 relative">
                            <div
                                class="absolute bottom-2 right-2 text-right z-40 bg-white px-3 py-1 rounded-lg font-display">
                                <span class="font-bold text-everglade-500">$116</span> per night
                            </div>
                            <img alt=""
                                 src="https://a0.muscache.com/im/pictures/miso/Hosting-812959360329830809/original/5cc6f191-bfa7-420a-9892-1d5b3fe4a98d.jpeg?im_w=480"
                                 width="1000" height="1000" decoding="async" data-nimg="future"
                                 class="sm:h-48 h-64 w-full object-cover rounded-lg" loading="lazy">
                        </div>
                        <div class="flex-1 py-4 flex flex-col justify-between">
                            <div class="flex-1">
                                <div class="flex items-center gap-x-1 text-gray-500">
                                    ...
                                    <h4 class="text-xs font-display uppercase font-bold leading-4">Barcelona, Catalunya,
                                        Spain</h4>
                                </div>
                                <h3 class="text-lg line-clamp-1 text-gray-900 font-display tracking-tight leading-6 mt-1">
                                    Boundra - El Born - Built for remote work.</h3>
                                <div class="relative group mt-2 w-fit">
                                    <div
                                        class="group-hover:opacity-100 duration-200 opacity-75 absolute bg-gradient-to-br from-yellow-500 to-cyan-500 -inset-0 rounded-full blur">
                                    </div>
                                    <div href="/settle"
									...
									<span class="font-bold text-base mr-1">44</span> coworking spaces </span>
                                    </div>
                                </div>
                                <div class="relative group mt-2 w-fit">
                                    <div
                                    ...
                                    <div href="/settle"
                                        ...
                                        <span class=" mr-1 text-everglade-500 text-xs">
										<span class="font-bold text-base mr-1">3</span> Wework locations </span>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <li class="cursor-pointer bg-white col-span-1 flex flex-col max-w-xl">
                    <a href="/listings/177" class="block">
                        <div class="flex-shrink-0 relative">
                            <div
                                class="absolute bottom-2 right-2 text-right z-40 bg-white px-3 py-1 rounded-lg font-display">
                                <span class="font-bold text-everglade-500">$632</span> per night
                            </div>
                            <img alt=""
                                 src="https://a0.muscache.com/im/pictures/prohost-api/Hosting-613800132617051942/original/f57ce74d-3c35-4cef-88db-34533f7ad31a.jpeg?im_w=480"
                                 width="1000" height="1000" decoding="async" data-nimg="future"
                                 class="sm:h-48 h-64 w-full object-cover rounded-lg" loading="lazy">
                        </div>
                        <div class="flex-1 py-4 flex flex-col justify-between">
                            <div class="flex-1">
                                <div class="flex items-center gap-x-1 text-gray-500">
                                    ...
                                    <h4 class="text-xs font-display uppercase font-bold leading-4">Truckee, California,
                                        United States</h4>
                                </div>
                                <h3 class="text-lg line-clamp-1 text-gray-900 font-display tracking-tight leading-6 mt-1">
                                    True Northstar ski-in/ski-out or hike with hot tub</h3>
                            </div>
                        </div>
                    </a>
                </li>
                <li class="cursor-pointer bg-white col-span-1 flex flex-col max-w-xl">
                    <a href="/listings/176" class="block">
                        <div class="flex-shrink-0 relative">
                            <div
                                class="absolute bottom-2 right-2 text-right z-40 bg-white px-3 py-1 rounded-lg font-display">
                                <span class="font-bold text-everglade-500">$478</span> per night
                            </div>
                            <img alt=""
                                 src="https://a0.muscache.com/im/pictures/prohost-api/Hosting-660268608842893158/original/c9bc9bd8-af9e-45a8-ae2e-14b2b7444467.jpeg?im_w=1440"
                                 width="1000" height="1000" decoding="async" data-nimg="future"
                                 class="sm:h-48 h-64 w-full object-cover rounded-lg" loading="lazy">
                        </div>
                        <div class="flex-1 py-4 flex flex-col justify-between">
                            <div class="flex-1">
                                <div class="flex items-center gap-x-1 text-gray-500">
                                    ...
                                    <h4 class="text-xs font-display uppercase font-bold leading-4">Cave Creek, Arizona,
                                        United States</h4>
                                </div>
                                <h3 class="text-lg line-clamp-1 text-gray-900 font-display tracking-tight leading-6 mt-1">
                                    5 Private Acres w/ Gym, Sauna &amp; Views near Phoenix</h3>
                            </div>
                        </div>
                    </a>
                </li>
