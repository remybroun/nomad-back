...
<head>
    ...
    @vite([base_path('resources/sass/app.scss'), base_path('resources/js/app.js')])
    ...
    <meta property="og:description"
          content="Boundra is a community of creatives who live and work remotely. We provide housing, workspaces, and community for creatives who want to live and work remotely.">
